...
INSERT INTO users(
    email, gender, jmbg, name, occupation, password, surname, address_id, enabled, last_password_reset_date)
VALUES ('medicalworker2@mail.com', 1, '1232312321321', 'Marko', 'Student', '$2y$10$1KJBnDRXEz87Zcrq.b3vR.hkmaVVIvXarI.4IwbtebcbAcMSjOJkK', 'Nikolic', 1, true, '2022-11-28 18:17:53.840417');

INSERT INTO users(
    email, gender, jmbg, name, occupation, password, surname, address_id, enabled, last_password_reset_date)
VALUES ('medicalworker3@mail.com', 1, '1232312321321', 'Milan', 'Student', '$2y$10$1KJBnDRXEz87Zcrq.b3vR.hkmaVVIvXarI.4IwbtebcbAcMSjOJkK', 'Tot', 1, true, '2022-11-28 18:17:53.840417');
...
INSERT INTO users(
    email, gender, jmbg, name, occupation, password, surname, address_id, enabled, last_password_reset_date)
VALUES ('donor4@mail.com', 0, '7132372111321', 'Mirko', 'Bravar', '$2y$10$9INQk3/KYVWY1FbUqA0W5upioL.6RVl63zJU9iEwQG.XvHEk9Aug6', 'Matijevic', 2, true, '2022-11-28 18:17:53.840417');
...
INSERT INTO users(
    email, gender, jmbg, name, occupation, password, surname, address_id, enabled, last_password_reset_date)
VALUES ('donor6@mail.com', 0, '7101372111321', 'Vasilije', 'Majstor elektrike', '$2y$10$9INQk3/KYVWY1FbUqA0W5upioL.6RVl63zJU9iEwQG.XvHEk9Aug6', 'Maric', 1, true, '2022-11-28 18:17:53.840417');

INSERT INTO users(
    email, gender, jmbg, name, occupation, password, surname, address_id, enabled, last_password_reset_date)
VALUES ('donor7@mail.com', 0, '2232372111321', 'Milos', 'Sportista', '$2y$10$9INQk3/KYVWY1FbUqA0W5upioL.6RVl63zJU9iEwQG.XvHEk9Aug6', 'Milesic', 3, true, '2022-11-28 18:17:53.840417');
...
INSERT INTO donor(
    blood_type, category, penalty, points, id, has_survey)
VALUES (1, 0, 0, 2, 8, false);

INSERT INTO donor(
    blood_type, category, penalty, points, id, has_survey)
VALUES (1, 2, 0, 98, 9, false);

INSERT INTO donor(
    blood_type, category, penalty, points, id, has_survey)
VALUES (5, 0, 0, 1, 10, false);
...
VALUES ('2023-01-22 13:00:28.111756','2023-01-22 14:00:28.112755',1, 1, 1, 1);

INSERT INTO appointment_slot(
    start_time, end_time, donor_id, blood_bank_id, status,version)
VALUES ('2022-12-27 17:00:28.111756','2022-12-27 18:00:28.112755',1, 2, 1,1);

INSERT INTO appointment_slot(
    start_time, end_time, donor_id, blood_bank_id, status,version)
VALUES ('2022-12-30 11:00:28.111756','2022-12-30 10:00:28.112755',6, 2, 1,1);
...
INSERT INTO USER_ROLE (user_id, role_id) VALUES (9, 1); -- user-u dodeljujemo rolu DONOR
INSERT INTO USER_ROLE (user_id, role_id) VALUES (10, 1); -- user-u dodeljujemo rolu DONOR
INSERT INTO USER_ROLE (user_id, role_id) VALUES (11, 1); -- user-u dodeljujemo rolu DONOR
...
INSERT INTO complaint(
    id, description, version, donor_id)
VALUES (2, 'Zalba2 asdas.  (banka bankaB)', 0, 6);
