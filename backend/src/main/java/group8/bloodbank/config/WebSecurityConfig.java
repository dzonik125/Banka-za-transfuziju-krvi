package group8.bloodbank.config;

import group8.bloodbank.security.auth.RestAuthenticationEntryPoint;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    	...
    	http.authorizeRequests().antMatchers("/auth/**").permitAll()		// /auth/**
			...
			.antMatchers("/bloodBanks/findAllBloodBanks").permitAll()// /api/foo
				.antMatchers("/appSlots/**").permitAll()// /api/foo
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
    	...
    	return (web) -> web.ignoring().antMatchers(HttpMethod.POST, "/auth")
