...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendVerificationEmail(Donor donor) throws MessagingException, UnsupportedEncodingException {
        ...
        String verifyUrl =  "http://localhost:8081/auth/verify?code=" + donor.getVerificationCode();
        String messageText = "Please click on the below link to activate your account: ";
        String title = "Confirm your email";
        String linkMessage = "Activate";
        String content = buildMessage(title,messageText, donor.getName(), linkMessage, verifyUrl);
        sendMail(donor, subject, content);
    }
    ...
    public void sendAppointmentInformationMail(Donor donor, String url) throws MessagingException, UnsupportedEncodingException {
        ...
        String content = buildMessageWithQRCode(title, messageText, donor.getName(), imagePath);
        sendMail(donor, subject, content);
    }
...
//        String messageText = "Please scan the code for more information about your scheduled appointments.: ";
    ...
    private void sendMail(Donor donor, String subject, String content) throws MessagingException, UnsupportedEncodingException {
        MimeMessage message = mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message);

        helper.setFrom("testnalogpsw@gmail.com", "Blood Bank");
        //helper.setTo("davidmijailovic9@gmail.com");
        //helper.setTo("dzonik125@gmail.com");
    ...
    private String buildMessageWithQRCode(String title, String message, String name, String imagePath) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                "\n" +
                "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
                "\n" +
    ...
    private String buildScheduledAppMessageWithoutQRCode(String title, String message, String name) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                "\n" +
                "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
                "\n" +
