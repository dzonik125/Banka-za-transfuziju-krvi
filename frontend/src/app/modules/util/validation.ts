  export class Validator {
    ...
    public checkNameEmpty(field: any) {
      var err = document.getElementById('emptyNameAlert') as HTMLInputElement | null;
    ...
    public checkCountryEmpty(field: any) {
      var err = document.getElementById('emptyCountryAlert') as HTMLInputElement | null;
    ...
    public checkCityEmpty(field: any) {
      var err = document.getElementById('emptyCityAlert') as HTMLInputElement | null;
